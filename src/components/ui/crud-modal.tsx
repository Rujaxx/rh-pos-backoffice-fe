...
export interface CrudModalProps<TFormData extends Record<string, unknown> = Record<string, unknown>> {
  // Modal state
  isOpen: boolean
  onClose: () => void
...
export function CrudModal<TFormData extends Record<string, unknown> = Record<string, unknown>>({
  isOpen,
  onClose,
  title,
  description,
...
export function useConfirmationModal() {
  const [isOpen, setIsOpen] = React.useState(false)
  const [onConfirm, setOnConfirm] = React.useState<(() => Promise<void>) | null>(null)
