 ...
 */
export const getS3UrlFromKey = (uploadKey: string | null | undefined): string => {
  if (!uploadKey) return ''
...
export const isValidS3Url = (url: string): boolean => {
  ...
  const devBucketUrl = 'https://rhpos-uploads-dev.s3.me-central-1.amazonaws.com'
  const prodBucketUrl = 'https://rhpos-uploads-production.s3.me-central-1.amazonaws.com'
