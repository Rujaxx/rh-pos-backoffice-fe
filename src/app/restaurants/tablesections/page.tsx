...
export default function TableSectionsPage() {
  ...
  // API hooks
  const {
    data: tableSectionsResponse,
    isLoading,
    error,
  } = useGetTableSections(queryParams);
  ...
  const latestTableSectionData =
    individualTableSectionResponse?.data || editingTableSection;
  ...
  const handleSubmit = useCallback(
    async (data: TableSectionFormData) => {
      try {
  ...
  const isFormLoading =
    createTableSectionMutation.isPending ||
    updateTableSectionMutation.isPending ||
    isLoadingIndividualTableSection ||
    isFetchingIndividualTableSection;
