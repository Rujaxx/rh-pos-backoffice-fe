...
export default function BrandsPage() {
  ...
  const columns = [
        ...
        <div className="flex items-center">
          <div className="relative w-10 h-10">
            <Image
              src={
                brand.logo ||
                `https://ui-avatars.com/api/?name=${encodeURIComponent(brand.name.en)}&background=random`
              }
              alt={brand.name.en}
              width={40}
              height={40}
    ...
    },
    {
      ...
      accessor: (brand: Brand) =>
        brand.createdAt?.toLocaleDateString() || 'N/A',
      sortable: true,
    },
  ];
  ...
  const actions: TableAction<Brand>[] = [
    ...
    },
    {
      ...
      variant: 'destructive',
      onClick: (brand) => {
        openConfirmationModal(() => handleDeleteBrand(brand), {
